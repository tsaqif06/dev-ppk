                ...
                <form class="row g-3">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" disabled type="text" value="{{ $data->barantin->preregister->jenis_perusahaan }}"">
                            </div>
                        </div>
                        <div class="row
                                    mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="nitku" disabled required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" disabled id="nama_alias_perusahaan">
                            </div>
                        </div>
                        <hr style="border-top: 3px solid rgb(119, 59, 3);" class="mb-1" />
