            ...
            <form class="row" id="form-register">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" readonly value="{{ $register->jenis_perusahaan }}" name="identifikasi_perusahaan" id="identifikasi_perusahaan" type="text" id="" name="">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input class="form-control" type="number" placeholder="Nomor Identitas" id="nomor_identitas" name="nomor_identitas" value="{{ $baratan->nomor_identitas ?? '' }}"maxlength="16" oninput="this.value = this.value.slice(0, 16);">
            ...
            <div>
                <form id="form-penandatangan">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input class="form-control" type="number" placeholder="Nomer Identitas" id="nomor_identitas_tdd" name="nomor_identitas_tdd" value="{{ $baratan->nomor_identitas_tdd ?? '' }}" maxlength="16" oninput="this.value = this.value.slice(0, 16);">
