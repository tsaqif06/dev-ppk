            ...
            <form class="row" id="form-register">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col">
                            <input class="form-control" type="text" placeholder="Nomor Identitas" id="nomor_identitas" name="nomor_identitas" value="{{ $baratan->nomor_identitas ?? '' }}" maxlength="16" oninput="this.value = this.value.slice(0, 16);">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="telepon" name="telepon" aria-describedby="inputGroupPrepend" required value="{{ $baratan->telepon ?? '' }}">
