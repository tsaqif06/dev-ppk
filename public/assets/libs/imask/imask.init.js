!(function (t, e) {
    ...
    function r(t, e) {
        ...
        if (e && t && "object" == typeof e && "object" == typeof t) {
            ...
            for (a = 0; a < o.length; a++) if (!r(t[o[a]], e[o[a]])) return !1;
            return !0;
        }
        return (
        ...
        if (h.Masked) {
            ...
            const { mask: e, ...a } =
                t instanceof h.Masked
                    ? { mask: t }
                    : s(t) && t.mask instanceof h.Masked
                        ? t
                        : {};
            if (e) {
                const t = e.mask;
    ...
    class g extends c {
        ...
        get rootElement() {
            ...
            return null !=
                (t =
                    null == (e = (s = this.input).getRootNode)
                        ? void 0
                        : e.call(s))
                ? t
                : document;
    ...
    h.HTMLContenteditableMaskElement = m;
    class _ {
        constructor() {
    ...
    class f {
        ...
        maskEquals(t) {
            ...
            return (
                null == t ||
                (null == (e = this.masked) ? void 0 : e.maskEquals(t))
            );
        }
        get mask() {
        ...
        set mask(t) {
            ...
            const e = t instanceof h.Masked ? t : d({ mask: t });
    ...
    class C {
        ...
        splice(t, e, s, i, n) {
            void 0 === i && (i = a.NONE), void 0 === n && (n = { input: !0 });
            const r = t + e,
                o = this.extractTail(r),
                h = !0 === this.eager || "remove" === this.eager;
            let l;
            h && ((i = u(i)), (l = this.extractInput(0, r, { raw: !0 })));
            let p = t;
            const d = new v();
            if (
                (i !== a.NONE &&
                    ((p = this.nearestInputPos(
                        t,
                        e > 1 && 0 !== t && !h ? a.NONE : i
                    )),
                        (d.tailShift = p - t)),
                    d.aggregate(this.remove(p)),
                    h && i !== a.NONE && l === this.rawInputValue)
            )
                if (i === a.FORCE_LEFT) {
                    let t;
                    for (
                        ;
                        l === this.rawInputValue &&
                        (t = this.displayValue.length);

                    )
                        d.aggregate(new v({ tailShift: -1 })).aggregate(
                            this.remove(t - 1)
                        );
    ...
    class A {
        ...
        extend(t) {
            ...
            if (t instanceof E)
                i ? s.extend(t.toString()) : this.chunks.push(t);
    ...
    class B {
        ...
        _appendPlaceholder() {
            return this.isFilled || this.isOptional
                ? new v()
                : ((this.isFilled = !0),
                    new v({ inserted: this.placeholderChar }));
        }
        _appendEager() {
            return new v();
        }
        ...
        doValidate(t) {
            return (
                ...
                (!this.parent ||
                    this.parent.doValidate(this.currentMaskFlags(t)))
            );
        }
        doCommit() {
            this.masked.doCommit();
                ...
                if (this.blocks) {
                    ...
                    if (i) {
                        const {
                            ...
                            n = null != e ? new h.RepeatBlock(u) : d(u);
                        n &&
                            (this._blocks.push(n),
                ...
                if ((s(this._blocks[i.index], i.index, u, n), t && !a)) {
                    for (let e = i.index + 1; e < t.index; ++e)
                        s(
                            ...
                            e,
                            0,
                            this._blocks[e].displayValue.length
                        );
    ...
    class D extends b {
        ...
        _update(t) {
            ...
            let o = 0;
            for (; o < r.length && r[o] === n[o];) ++o;
            (u.mask =
                r.slice(0, o).replace(/0/g, "\\0") +
        ...
        _update(t) {
            ...
            t.min && (n.Y.from = t.min.getFullYear()),
                ...
                ((n.m.from = t.min.getMonth() + 1),
                    ...
                    n.m.from === n.m.to &&
                    ((n.d.from = t.min.getDate()),
                        (n.d.to = t.max.getDate()))),
    ...
    class M extends C {
                ...
                (this.currentMask !== r
                    ? (this.currentMask.reset(),
                        ...
                        (this.currentMask.append(u, { raw: !0 }),
                            (o.tailShift =
                                this.currentMask.value.length - i.length)),
                        n &&
                        (o.tailShift += this.currentMask.append(n, {
                            raw: !0,
                            tail: !0,
                        }).tailShift))
        ...
        get isFilled() {
            var t;
            return Boolean(
                null == (t = this.currentMask) ? void 0 : t.isFilled
            );
        }
        remove(t, e) {
            const s = new v();
        ...
        extractInput(t, e, s) {
            return this.currentMask
                ? this.currentMask.extractInput(t, e, s)
                : "";
        }
        extractTail(t, e) {
            return this.currentMask
        ...
        _appendCharRaw(t, e) {
            ...
            const h =
                e.tail && e._beforeTailState
                    ? e._beforeTailState._value
                    : this._value,
                l = this._separatorsCountFromSlice(h);
    ...
    (h.PIPE_TYPE = P), (h.createPipe = R), (h.pipe = O);
    class L extends b {
        get repeatFrom() {
            var t;
            return null !=
        ...
        _update(t) {
            ...
            (this.repeat =
                null !=
                    (e = null != (s = null != a ? a : n.repeat) ? s : this.repeat)
                    ? e
                    : 1 / 0),
                super._update({
                    mask: "m".repeat(
        ...
        _appendCharRaw(t, e) {
            ...
            for (
                ...
                (r =
                    null != (u = this._blocks[h])
                        ? u
                        : (o = !o && this._allocateBlock(h)));
                ++h
            ) {
                var i, a, u, n;
